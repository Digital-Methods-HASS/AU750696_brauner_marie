...
# YOUR CODE HERE:
library(tidyverse)
kings <- read_csv2("Kongerækker_assignment_7.csv")
...
Comparing the two figures provides a compelling picture of societal development over the last several centuries. The first figure, showing historical homicides across various European regions, clearly demonstrates a substantial decline in deaths from year 1300 to the present. For example, Italy and the Netherlands/Belgium experienced homicide rates exceeding 50 per 100,000 in the late medieval period, while by the 20th century, rates had dropped to around 1–5 per 100,000. England and Scandinavia show similar trends, with homicides becoming rare after 1800. This consistent decrease across regions indicates that societies have become considerably less violent, suggesting stronger social norms, legal enforcement, and conflict resolution mechanisms over time.
